...
safety through a stable employment, increased income and hence financial security.
...
demand for career counseling services. These drivers are more specific to our customer segments and are therefore of 
utmost importance when designing innovative solutions and business models in career counseling. Based on the persona 
introduced in the previous section, we can identify several customer drivers related to self-esteem and even to
self-actualization. The goal of a career plan is to advance in life to reach higher-level goals. Through career 
advancement, customers achieve higher incomes, reach higher social status, gain more recognition and progressively
...
alignments allows them to fulfill their self-actualization needs.
...
and persona previously introduced.
