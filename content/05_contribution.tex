...
The CCaaS business model builds upon the availability of large amounts of user data and data
science know-how. The following technical aspects are relevant in relation to career counseling
as CCaaS offering:
...
\begin{itemize}
    ...
    \item \textbf{Liability:} the CCaaS platform provides recommendations for trainings and career
        ...
        should be liable for any damage caused counselors based on downtimes that render CCaaS API services
        inaccessible to the counselors.
