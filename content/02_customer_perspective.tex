...
In order to develop a successful business model in the digital age, it is crucial to first understand
the customer's perspective. This customer-centricity allows to develop a business innovation and business
model that is tailored to the customer's needs and drivers, thereby increasing the chances of success
\citep[p.~193-195]{schwafertsLectureStrategicBusiness2023}.
...
\subsection{Drivers and the Environment}
...
To fully understand the expectations of a potential customer, we also need to consider how the person perceives its
environment \citep[p.~194]{schwafertsLectureStrategicBusiness2023}. Besides drivers introduced previously, the 
true needs of a person may be rooted elsewhere. The persona we introduced is at a stepping stone in her life. Thus, 
she might be anxious to make a wrong career choice that will affect her for the rest of her life. She is thus highly 
attentive to her environment. Her current environment consists of the university and student life, friends and 
family. Sarah is also attentive to political and societal changes, such as a drive more for gender equality. With 
rapid progress of AI, she might however also be hostile to technological progress. She might perceive it as a 
threat to her own career that she could be replaced by AI some day. When designing CCaaS services we can account 
for this perception of a potential threat by involving humans into the AI decision-making processes instead of 
attempting to fully automate tasks that are traditionally performed by humans.

\subsubsection{Self-Presentation in the Environment}

Equally important is how the person presents itself to the environment. Our persona Sarah is highly educated and  
has high ethical and moral standards. As such, she wants to present herself as a highly capable and morally 
integer person. When designing CCaaS services we can account for such ethical and cultural values that are 
central to a person. For example, the CCaaS can recommend employers and industries that are aligned with the
person's values. This can be achieved by analyzing the job descriptions and company profiles for keywords
that are relevant to the person's values.

\subsection{Value Proposition}


The value proposition of a business represents the value that is expected to be generated and delivered to the
customer. It can also be described as the unique selling proposition. Tools like the value proposition canvas, 
which was introduced by \cite{osterwalderValuePropositionDesign2014}, can help entrepreneurs design effective
value propositions. However, the value proposition canvas may not fit very well
