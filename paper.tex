...
%% Paper cover page
%%
\title{... as a Strategic Business Innovation within the Digital Ecosystem of AI-powered Career Counseling}
...
\newpage
\input{content/03_customer_perspective}

%%% Drivers
\newpage
\input{content/04_drivers}

%%% Enablers
\newpage
\input{content/05_enablers}

%%% Business Model
\newpage
\input{content/06_business_model}
